          ...
          <div className="flex flex-col justify-center items-center px-4 py-6 bg-gradient-to-tr from-[#241868] to-[#392B43] rounded-lg shadow-lg dark:bg-neutral-800">
            ...
            <Link to="/login">
              <button
                type="button"
                id="outlineBox"
                className="signUp mb-32 inline-block  rounded px-6 pt-2.5 pb-2 text-xs font-medium uppercase w-52 leading-normal text-white shadow-[0_4px_9px_-4px_rgba(0,0,0,0.2)] transition duration-150 ease-in-out hover:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:outline-none focus:ring-0 active:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)]"
                style={{
          ...
          <div className="flex flex-col justify-center items-center px-4 py-6 text-white bg-gradient-to-tr from-[#241868] to-[#392B43] rounded-lg rounded-b-lg md:mx-6 md:p-12">
            {data ? (
              ...
              <form className="form login-form" onSubmit={handleFormSubmit}>
                <p className="mb-4 text-center">Create an account</p>
